...
var WhitePaper = function WhitePaper(_ref) {
  ...
  return __jsx(_WhitePaper_styled__WEBPACK_IMPORTED_MODULE_3__["WhitePaperWrapper"], {
    ...
    description: "The ability to apply accurate and relevant data is the key to unlocking future business benefits under the Fundamental Review of the Trading Book (FRTB) regime and the strengthening of the value-at-risk (VaR) framework for capital adequacy...",
    notchColor: _assets_colors__WEBPACK_IMPORTED_MODULE_2__["PINK"],
    onClick: function onClick() {
      return _onClick('riskFramework');
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18
...
//# sourceMappingURL=research.js.10583047a37c09ad5ea1.hot-update.js.map