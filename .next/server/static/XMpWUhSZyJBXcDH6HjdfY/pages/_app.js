...
var analyticsService_AnalyticsService = function AnalyticsService(trackingId) {
  var _this = this;

  Object(classCallCheck["default"])(this, AnalyticsService);

  Object(defineProperty["a" /* default */])(this, "initialize", function () {
    external_react_ga_default.a.initialize(_this.trackingId);
  });

  Object(defineProperty["a" /* default */])(this, "trackPage", function (path) {
...
var analyticsService = new analyticsService_AnalyticsService('UA-149172193-1');
    ...
    value: function componentDidUpdate() {
      ...
      if (this.state.currentRoute !== this.props.router.route) {
        this.setState({
          ...
          services_analyticsService.trackPage(_this2.state.currentRoute);
        });
      }
    }
    /**
