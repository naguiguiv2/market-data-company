...
})(["font-family:", ";font-size:21px;line-height:30px;color:", ";margin:0;text-align:center;", ""], props => props.theme.fonts.financier, props => props.theme.colors.black, external_styled_components_breakpoint_default()('desktop')`
    font-size: 36px;
    line-height: 42px;
  `);
...
const Landing = () => landing_jsx(LandingWrapper, null, landing_jsx(ContentWrapper, null, landing_jsx(tab_bar["a" /* default */], {
  barTheme: "dark"
}), landing_jsx(Content, null, landing_jsx(Description, null, "MDC has done extensive research over the past 10 years through its qualitative and quantitative analytics. Our findings have been linked to the strength of a firms operational management, and have been used to improve capabilities in client intelligence, trading strategies, and business productivity."))));
...
const WhitePaper = ({
  onClick
}) => white_paper_jsx(WhitePaperWrapper, null, white_paper_jsx(WhitePaperTitle, null, "White Papers"), white_paper_jsx(animated_card["a" /* default */], {
...
/* harmony default export */ var pages_research = __webpack_exports__["default"] = (() => {
  ...
  return pages_research_jsx(components["d" /* Layout */], null, pages_research_jsx(landing, null), pages_research_jsx(components["e" /* Modal */], {
