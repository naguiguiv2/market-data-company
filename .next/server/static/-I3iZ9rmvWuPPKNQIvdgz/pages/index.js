...
})(["display:flex;flex-direction:row;justify-content:space-between;max-width:332px;margin:0 0 38px 0;", ""], external_styled_components_breakpoint_default()('desktop')(_templateObject5()));
...
var leader_market_data_LeaderMarketData = function LeaderMarketData() {
  return external_react_default.a.createElement(LeaderMarketDataWrapper, null, external_react_default.a.createElement(Content, null, external_react_default.a.createElement(InfoWrapper, null, external_react_default.a.createElement(LeaderMarketData_styled_Title, null, "Leader in market data consulting"), external_react_default.a.createElement(InfoText, null, "Market Data Company is a professional consulting firm with experts skilled in Market Data products and Management. We are committed to helping financial investment firms optimize Market and Reference data spend."), external_react_default.a.createElement(InfoText, null, "We partner with our clients to answer the growing demands of their business by providing the expertise in the details that lead to increased profitability. Specifically, MDC has developed a series of diagnostic tools and programs that tangibly drive down costs while optimizing services.")), external_react_default.a.createElement(FactsWrapper, null, external_react_default.a.createElement(ProjectsCompletedWrapper, null, external_react_default.a.createElement(NumberText, null, "106"), external_react_default.a.createElement(FactsText, null, "Projects completed")), external_react_default.a.createElement(ProjectsCompletedWrapper, null, external_react_default.a.createElement(NumberText, null, "$154MM"), external_react_default.a.createElement(FactsText, null, "Client dollars saved")))));
};
...
})(["display:flex;flex-direction:column;flex:1;margin-bottom:93px;", ""], external_styled_components_breakpoint_default()('desktop')(Research_styled_templateObject()));
...
var services_Services = function Services() {
  return external_react_default.a.createElement(ServicesWrapper, null, external_react_default.a.createElement(Services_styled_HeaderWrapper, null, external_react_default.a.createElement(Services_styled_HeaderTitle, null, "What our services can do for you"), external_react_default.a.createElement(Services_styled_HeaderDescription, null, "Taking Benchmarking to an entirely different level, our marketing data services offers you exceptional insight into the capital markets industry. With our current commercial solutions, you have the tools to take your strategy to the next level.")), external_react_default.a.createElement(Services_styled_ContentWrapper, null, external_react_default.a.createElement(Services_styled_CardWrapper, null, external_react_default.a.createElement(CardImage, {
...
var why_mdc_WhyMdc = function WhyMdc() {
  ...
  return external_react_default.a.createElement(WhyMdcWrapper, null, external_react_default.a.createElement(HeadingWrapper, null, external_react_default.a.createElement(HeadingTitle, null, "Why Market Data Company?"), external_react_default.a.createElement(HeadingDescription, null, "From inception, our focus has been on the dynamics and complexities of market data and the critical third-party relationships built through data providers within the Capital Markets and Wealth Management industries.")), external_react_default.a.createElement(WhyMdc_styled_Content, null, renderDescription()));
};
...
var WorkedWith_styled_Description = external_styled_components_default.a.p.withConfig({
  ...
  return props.theme.fonts.financier;
}, external_styled_components_breakpoint_default()('desktop')(WorkedWith_styled_templateObject()));
...
})(["width:48%;margin-bottom:40px;transform:scale(0.75);display:flex;justify-content:center;", " ", ""], external_styled_components_breakpoint_default()('tablet')(WorkedWith_styled_templateObject2()), external_styled_components_breakpoint_default()('desktop')(WorkedWith_styled_templateObject3()));
...
})(["max-width:1200px;margin:0 20px;", ""], external_styled_components_breakpoint_default()('tablet')(pages_templateObject()));
