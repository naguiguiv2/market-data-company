...
})(["display:flex;flex-direction:column;align-items:center;justify-content:center;margin:0 20px;min-height:360px;", ""], external_styled_components_breakpoint_default()('desktop')(_templateObject3()));
...
})(["display:flex;flex-direction:row;justify-content:space-between;width:100%;margin-bottom:17px;", ""], external_styled_components_breakpoint_default()('desktop')(_templateObject5()));
...
var CaseStudyWrapper = external_styled_components_default.a.div.withConfig({
  displayName: "CaseStudiesstyled__CaseStudyWrapper",
  componentId: "sc-118xv7t-0"
})(["display:flex;flex-direction:column;flex:1;margin-bottom:80px;", ""], external_styled_components_breakpoint_default()('desktop')(_templateObject()));
var CaseStudyTitle = external_styled_components_default.a.h1.withConfig({
...
var case_studies_CaseStudies = function CaseStudies(_ref) {
  var _onClick = _ref.onClick;
  return external_react_default.a.createElement(CaseStudyWrapper, null, external_react_default.a.createElement(CaseStudyTitle, null, "Case Studies"), external_react_default.a.createElement(animated_card["a" /* default */], {
...
/* harmony default export */ var case_studies = (case_studies_CaseStudies);
// CONCATENATED MODULE: ./sections/research-section/landing/Landing.styled.js


function Landing_styled_templateObject() {
  var data = Object(taggedTemplateLiteral["a" /* default */])(["\n    font-size: 36px;\n    line-height: 42px;\n  "]);

  Landing_styled_templateObject = function _templateObject() {
    return data;
  };
...
var Description = external_styled_components_default.a.p.withConfig({
  ...
  return props.theme.colors.black;
}, external_styled_components_breakpoint_default()('desktop')(Landing_styled_templateObject()));
...
var landing_Landing = function Landing() {
  return external_react_default.a.createElement(LandingWrapper, null, external_react_default.a.createElement(ContentWrapper, null, external_react_default.a.createElement(tab_bar["a" /* default */], {
    barTheme: "dark"
  }), external_react_default.a.createElement(Content, null, external_react_default.a.createElement(Description, null, "MDC has done extensive research over the past 10 years through its qualitative and quantitative analytics. Our findings have been linked to the strength of a firms operational management, and have been used to improve capabilities in client intelligence, trading strategies, and business productivity."))));
};
...
var ResearchTitle = external_styled_components_default.a.h1.withConfig({
  ...
  return props.theme.fonts.graphikBold;
}, external_styled_components_breakpoint_default()('desktop')(Research_styled_templateObject2()));
var CardContentContainer = external_styled_components_default.a.div.withConfig({
  displayName: "Researchstyled__CardContentContainer",
  componentId: "f6bou7-2"
})(["display:flex;flex-direction:column;", ""], external_styled_components_breakpoint_default()('desktop')(_templateObject3()));
...
})(["margin-bottom:20px;", ""], external_styled_components_breakpoint_default()('desktop')(_templateObject4()));
...
function Survey_styled_templateObject2() {
  var data = Object(taggedTemplateLiteral["a" /* default */])(["\n    font-size: 36px;\n    line-height: 48px;\n    margin: 0 0 34px 0px;\n  "]);

  Survey_styled_templateObject2 = function _templateObject2() {
    return data;
  };
...
function Survey_styled_templateObject() {
  var data = Object(taggedTemplateLiteral["a" /* default */])(["\n    margin-bottom: 45px;\n  "]);

  Survey_styled_templateObject = function _templateObject() {
    return data;
  };
...
var SurveyWrapper = external_styled_components_default.a.div.withConfig({
  displayName: "Surveystyled__SurveyWrapper",
  componentId: "sc-176jyyk-0"
})(["display:flex;flex-direction:column;flex:1;margin-bottom:30px;", ""], external_styled_components_breakpoint_default()('desktop')(Survey_styled_templateObject()));
var SurveyTitle = external_styled_components_default.a.h1.withConfig({
  displayName: "Surveystyled__SurveyTitle",
  componentId: "sc-176jyyk-1"
})(["font-family:", ";font-size:24px;line-height:30px;margin:0 0 25px 0px;", ""], function (props) {
  return props.theme.fonts.graphikBold;
}, external_styled_components_breakpoint_default()('desktop')(Survey_styled_templateObject2()));
...
var survey_Survey = function Survey(_ref) {
  var _onClick = _ref.onClick;
  return external_react_default.a.createElement(SurveyWrapper, null, external_react_default.a.createElement(SurveyTitle, null, "Surveys"), external_react_default.a.createElement(animated_card["a" /* default */], {
...
/* harmony default export */ var survey = (survey_Survey);
// CONCATENATED MODULE: ./sections/research-section/white-paper/WhitePaper.styled.js


function WhitePaper_styled_templateObject2() {
  var data = Object(taggedTemplateLiteral["a" /* default */])(["\n    font-size: 36px;\n    line-height: 48px;\n    margin: 0 0 34px 0px;\n  "]);

  WhitePaper_styled_templateObject2 = function _templateObject2() {
    return data;
  };
...
function WhitePaper_styled_templateObject() {
  var data = Object(taggedTemplateLiteral["a" /* default */])(["\n    margin-bottom: 100px;\n  "]);

  WhitePaper_styled_templateObject = function _templateObject() {
    return data;
  };
...
var WhitePaperWrapper = external_styled_components_default.a.div.withConfig({
  displayName: "WhitePaperstyled__WhitePaperWrapper",
  componentId: "sc-137t1xd-0"
})(["display:flex;flex-direction:column;flex:1;margin-bottom:80px;", ""], external_styled_components_breakpoint_default()('desktop')(WhitePaper_styled_templateObject()));
var WhitePaperTitle = external_styled_components_default.a.h1.withConfig({
  displayName: "WhitePaperstyled__WhitePaperTitle",
  componentId: "sc-137t1xd-1"
})(["font-family:", ";font-size:24px;line-height:30px;margin:0 0 25px 0px;", ""], function (props) {
  return props.theme.fonts.graphikBold;
}, external_styled_components_breakpoint_default()('desktop')(WhitePaper_styled_templateObject2()));
...
var white_paper_WhitePaper = function WhitePaper(_ref) {
  var _onClick = _ref.onClick;
  return external_react_default.a.createElement(WhitePaperWrapper, null, external_react_default.a.createElement(WhitePaperTitle, null, "White Papers"), external_react_default.a.createElement(animated_card["a" /* default */], {
...
/* harmony default export */ var white_paper = (white_paper_WhitePaper);
...
var research_ContentWrapper = external_styled_components_default.a.div.withConfig({
...
/* harmony default export */ var pages_research = __webpack_exports__["default"] = (function () {
  ...
  })), external_react_default.a.createElement(research_ContentWrapper, null, external_react_default.a.createElement(research, {
    onClick: openModal
  }), external_react_default.a.createElement(white_paper, {
    onClick: openModal
  }), external_react_default.a.createElement(case_studies, {
    onClick: openModal
  }), external_react_default.a.createElement(survey, {
    onClick: openModal
  }), external_react_default.a.createElement(components["a" /* AnimatedFooterLink */], {
